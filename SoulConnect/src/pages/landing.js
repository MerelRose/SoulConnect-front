...
import Home from './components/login'; // Login component
...
const Landing = () => {
    ...
    const [formType, setFormType] = useState('login'); // State to track form type
    ...
    return (
        <div className="flex-1 overflow-y-auto w-fit h-[400px] sm:h-[500px] md:h-[600px] lg:h-[600px] bg-zinc-900">
            ...
            <div className='absolute flex space-x-16 bottom-24 left-20'>
                <img
                    src={holding}
                    className="shadow-2xl rounded-3xl w-96"
                    alt="hand holding"
                />
                <button
